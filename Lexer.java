/*
    ...
    los tokens de la siguiente gram??tica:
    S ::= E;
    E ::= E + E
        | E - E
        | E * E
        ...
        | number
    **** Cosas Importantes ****:
    1. Lo que est?? en min??scula son terminales
    2. Lo que est?? en may??scula son no terminales
    3. number son n??meros double de java que siguen el siguiente formato:
        signo   = [+-]
        digitos = [0-9]
        punto = .
        exponente = [eE]
        (digitos)+((punto)?(digitos)*)?((exponente)(signo)?(digitos)+)?
        donde '+' es uno o m??s veces
        donde '*' es cero o m??s veces
...
"15:9,2:2,15:2,0,15:18,2,15:4,7,15:2,10,11,5,3,15,4,13,6,12:10,15,1,15:9,14," +
"15:24,8,15:6,14,15:24,9,15,16:2")[0];
